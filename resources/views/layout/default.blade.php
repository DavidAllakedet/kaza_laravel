...
<head>
    ...
    <title>{{ $title }}</title> {{-- Titre de la page, dynamique avec la variable $title --}}
    <link rel="stylesheet" href="https://rsms.me/inter/inter.css"> {{-- Chargement de la feuille de style Inter --}}
    @vite(['resources/css/app.css', 'resources/js/app.js']) {{-- Chargement des ressources CSS et JS avec Vite --}}
</head>
<body class="antialiased pt-10 pb-16 md:pb-32"> {{-- Corps de la page avec des classes CSS pour le style --}}
